"""
11-03-2026 İstanbul ve Urfa programlarını çek
"""
import requests
import json
...
if __name__ == "__main__":
    print("=" * 80)
    print(f"🏇 İSTANBUL VE URFA PROGRAMLARI ({year}-{month:02d}-{day:02d})")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("✅ TAMAMLANDI!")
    print(f"Toplam {len(results)} şehir verisi çekildi")
    print("=" * 80)
