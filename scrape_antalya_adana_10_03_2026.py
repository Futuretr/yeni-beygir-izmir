"""
10-03-2026 Antalya ve Adana programlarını çek
"""
import requests
import json
...
if __name__ == "__main__":
    print("=" * 80)
    print(f"🏇 ANTALYA VE ADANA PROGRAMLARI ({year}-{month:02d}-{day:02d})")
    print("=" * 80)
    ...
    for city, data in results.items():
        print(f"✅ {city}: {len(data)} koşu")
    
    if not results:
        print("⚠️ Hiçbir şehirden veri alınamadı")
