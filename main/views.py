...
class RaceDayView(APIView):
    def get(self, request, format=None):
        ...
        if query_params.is_valid():
            ...
            page_type = query_params.cleaned_data.get('type', '').lower()

            results = None
            
            # If type=fixture is specified, fetch fixture page directly
            if page_type == 'fixture':
                try:
            ...
            # If type=result is specified, fetch result page directly
                ...
                # Default behavior: First we check if result page is available for the race
                try:
                    results = ResultScrapper.scrap_by_date(city, date)
