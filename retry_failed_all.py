"""
Retry all failed requests with 30 workers
"""
import requests
import json
import time
...
RETRY_FAILED_FILE = os.path.join(OUTPUT_DIR, "retry_failed_requests.json")
...
def main():
    """Main retry function with 30 workers"""
    global success_count, error_count, processed_count
    ...
    print(f"🔄 BAŞARISIZ İSTEKLERİ TEKRAR DENEME (30 WORKER)")
